...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($nombre) && $precio > 0 && $categoria_id > 0) {
        ...
        if ($stmt->execute()) {
            ...
            header('Location: productos.php?message=' . urlencode('Producto agregado correctamente') . '&type=success');
            exit;
        } else {
...
<head>
    ...
    <title>Agregar Producto - Island Bar</title>
            ...
            <header class="dashboard-header">
                <div class="header-left">
                    ...
                    <div>
                        ...
                        <p class="page-subtitle">Island Bar - Nuevo Producto</p>
                    </div>
                </div>
            ...
            <section class="dashboard-section active">
                <div class="section-header">
                    <div>
                        ...
                        <p class="section-description">Complete el formulario para agregar un nuevo producto al catálogo</p>
                    </div>
                ...
                <div class="table-container neon-card">
                    <form method="POST" class="modal-form" style="max-width: 600px; margin: 0 auto; padding: 30px;">
                        ...
                        <div class="form-actions" style="margin-top: 30px;">
                            <a href="productos.php" class="neon-button-outline">Cancelar</a>
                            <button type="submit" class="neon-button">Guardar Producto</button>
                        </div>
                    </form>
                </div>
            </section>
